...
Version  : 2.12.5
Release  : 25
URL      : https://www.freedesktop.org/software/fontconfig/release/fontconfig-2.12.5.tar.gz
Source0  : https://www.freedesktop.org/software/fontconfig/release/fontconfig-2.12.5.tar.gz
...
%prep
%setup -q -n fontconfig-2.12.5
%patch1 -p1
%patch2 -p1
%patch3 -p1
pushd ..
cp -a fontconfig-2.12.5 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1504974600
...
/usr/lib64/libfontconfig.so.1.10.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libfontconfig.so.1
/usr/lib32/libfontconfig.so.1.10.0
